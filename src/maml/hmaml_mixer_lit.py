...
def main(args,
    ...
    summary_fname = os.path.join(summary_output_dir, f"{f_base_model}_{args.exp_setting}_{args.num_meta_iterations}_{args.shots//2}{few_ft}{aux_la}_{args.target_lang}.json")
